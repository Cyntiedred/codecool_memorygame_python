...
def card_turn():
    ...
    if mark1 == 'A1':
        ...
        board_coor['A2'] = cards[2]
    elif mark1 == 'A3':
        board_coor['A3'] = cards[3]
    elif mark1 == 'A4':
        board_coor['A4'] = cards[4]
    elif mark1 == 'B1':
        board_coor['B1'] = cards[5]
    elif mark1 == 'B2':
        board_coor['B2'] = cards[6]
    elif mark1 == 'B3':
        board_coor['B3'] = cards[7]
    elif mark1 == 'B4':
        board_coor['B4'] = cards[8]
    elif mark1 == 'C1':
        board_coor['C1'] = cards[1]
    elif mark1 == 'C2':
        board_coor['C2'] = cards[2]
    elif mark1 == 'C3':
        board_coor['C3'] = cards[3]
    elif mark1 == 'C4':
        board_coor['C4'] = cards[4]
    elif mark1 == 'D1':
        board_coor['D1'] = cards[5]
    elif mark1 == 'D2':
        board_coor['D2'] = cards[6]
    elif mark1 == 'D3':
        board_coor['D3'] = cards[7]
    elif mark1 == 'D4':
        board_coor['D4'] = cards[8]
